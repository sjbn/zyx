...
+ (UIViewController *)presentingVC{
    ...
    if ([result isKindOfClass:[BNRootTabController class]]) {
        result = [(BNRootTabController *)result selectedViewController];
    }
...
+ (void)presentVC:(UIViewController *)viewController{
    ...
    UINavigationController *nav = [[BNBaseNavigationController alloc] initWithRootViewController:viewController];
